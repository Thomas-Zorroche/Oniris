...
#include "hud/InvPanel.hpp"
#include "hud/TargetPanel.hpp"
...
void Hud::Init()
{
	...
	AddPanel("p_crystal", std::make_shared<Panel>("res/img/hud/ui_crystal.png", "p_crystal", 0.8, -0.7, 0.8, 128, 5, true));
